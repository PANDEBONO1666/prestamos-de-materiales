...
class Autor extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            if ($data[$i]['estado'] == 1) {
                ...
                <button class="btn btn-danger" type="button" onclick="btnEliminarAutor(' . $data[$i]['id'] . ');"><i class="fa fa-power-off"></i>
</button>
                <div/>';
            } else {
    ...
    public function registrar()
    {
        ...
        if (empty($autor)) {
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    $msg = array('msg' => 'Dueño registrado', 'icono' => 'success');
                    if (!empty($name)) {
                ...
                if ($data == "modificado") {
                    ...
                    $msg = array('msg' => 'Dueño modificado', 'icono' => 'success');
                } else {
    ...
    public function eliminar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Dueño dado de baja', 'icono' => 'success');
        } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Dueño restaurado', 'icono' => 'success');
        } else {
