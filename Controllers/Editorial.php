...
class Editorial extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            if ($data[$i]['estado'] == 1) {
                ...
                <button class="btn btn-danger" type="button" onclick="btnEliminarEdi(' . $data[$i]['id'] . ');"><i class="fa fa-power-off"></i>
</button>
                <div/>';
            } else {
        ...
        if (empty($editorial)) {
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    ...
                    $msg = array('msg' => 'El  ya existe', 'icono' => 'warning');
                } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Marca restaurado', 'icono' => 'success');
        } else {
