...
class Estudiantes extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            if ($data[$i]['estado'] == 1) {
                ...
                <button class="btn btn-danger" type="button" onclick="btnEliminarEst(' . $data[$i]['id'] . ');"><i class="fa fa-power-off"></i>
</button>
                <div/>';
            } else {
    ...
    public function registrar()
    {
        ...
        if (empty($codigo) || empty($dni) || empty($nombre) || empty($carrera)) {
            ...
            if ($id == "") {
                    ...
                    if ($data == "ok") {
                        $msg = array('msg' => 'Personal registrado', 'icono' => 'success');
                    } else if ($data == "existe") {
                ...
                if ($data == "modificado") {
                    $msg = array('msg' => 'Personal modificado', 'icono' => 'success');
                } else {
    ...
    public function eliminar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Personal dado de baja', 'icono' => 'success');
        } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Personal restaurado', 'icono' => 'success');
        } else {
