...
class Materia extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            if ($data[$i]['estado'] == 1) {
                ...
                <button class="btn btn-danger" type="button" onclick="btnEliminarMat(' . $data[$i]['id'] . ');"><i class="fa fa-power-off"></i>
</button>
                <div/>';
            } else {
    ...
    public function registrar()
    {
        ...
        if (empty($materia)) {
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    $msg = array('msg' => 'Area registrado', 'icono' => 'success');
                } else if ($data == "existe") {
                    $msg = array('msg' => 'El Area ya existe', 'icono' => 'warning');
                } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Area restaurado', 'icono' => 'success');
        } else {
