...
class Libros extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            if ($data[$i]['estado'] == 1) {
                ...
                <button class="btn btn-danger" type="button" onclick="btnEliminarLibro(' . $data[$i]['id'] . ');"><i class="fa fa-power-off"></i>
</button>
                <div/>';
            } else {
        ...
        if (empty($titulo) || empty($autor) || empty($editorial) || empty($materia) || empty($cantidad)) {
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    ...
                    $msg = array('msg' => 'Material registrado', 'icono' => 'success');
                } else if ($data == "existe") {
                    $msg = array('msg' => 'El Material ya existe', 'icono' => 'warning');
                } else {
                ...
                if ($data == "modificado") {
                    ...
                    $msg = array('msg' => 'Material modificado', 'icono' => 'success');
                } else {
    ...
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Material restaurado', 'icono' => 'success');
        } else {
