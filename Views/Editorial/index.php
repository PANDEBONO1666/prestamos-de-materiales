...
<div class="app-title">
    <div>
        <h1><i class="fa fa-id-card"></i> Marca del Producto</h1>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white" id="title">Registro Marca</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="editorial" class="form-control" type="text" name="editorial" required placeholder="Nombre de Marca">
                            </div>
                        </div>
