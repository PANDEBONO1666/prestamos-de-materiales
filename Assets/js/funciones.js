...
function frmUsuario() {
    document.getElementById("title").textContent = "Nuevo Administrador";
...
function frmEstudiante() {
    document.getElementById("title").textContent = "Nuevo Personal";
    document.getElementById("btnAccion").textContent = "Registrar";
...
function btnEliminarEst(id) {
    Swal.fire({
        title: 'Esta seguro de eliminar?',
        text: "El Personal no se eliminará de forma permanente, solo cambiará el estado a inactivo!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
//Fin Estudiante
function frmMateria() {
    document.getElementById("title").textContent = "Nuevo Area";
    document.getElementById("btnAccion").textContent = "Registrar";
...
function btnEliminarMat(id) {
    Swal.fire({
        title: 'Esta seguro de eliminar?',
        text: "El Area no se eliminará de forma permanente, solo cambiará el estado a inactivo!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
//Fin Materia
function frmAutor() {
    document.getElementById("title").textContent= "Nuevo Dueño";
    document.getElementById("btnAccion").textContent= "Registrar";
...
function btnEliminarAutor(id) {
    Swal.fire({
        title: 'Esta seguro de eliminar?',
        text: "El Dueño no se eliminará de forma permanente, solo cambiará el estado a inactivo!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
//Fin editorial
function frmLibros() {
    document.getElementById("title").textContent = "Nuevo Material";
    document.getElementById("btnAccion").textContent = "Registrar";
...
function btnEliminarLibro(id) {
    Swal.fire({
        title: 'Esta seguro de eliminar?',
        text: "El Material no se eliminará de forma permanente, solo cambiará el estado a inactivo!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
function btnEliminar(id) {
    if (confirm('¿Está seguro de eliminar este préstamo?')) {
        fetch('tu_base_url/Prestamos/eliminar/' + id, {
            method: 'DELETE',
            headers: {
